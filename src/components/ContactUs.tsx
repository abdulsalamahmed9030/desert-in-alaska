        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm">
            ...
            <form className="space-y-5">
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-2 rounded-md bg-[#86522d] px-6 py-3 text-sm font-semibold text-white hover:bg-[#6f4224]"
              >
                Send Message →
              </button>
            </form>
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-[#6b5a4d] max-w-md">
